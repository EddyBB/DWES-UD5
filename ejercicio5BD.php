<?php
    ...
    $usuario = "developer";
    $pass = "developer";
    function insertaElemento($nombreUsuario,$contrasenya,$cuentaBank){
            try {
                $conexion = new PDO("mysql:host=$GLOBALS[servidor];dbname=$GLOBALS[baseDatos]", $GLOBALS["usuario"], $GLOBALS["pass"]);
            
                $sql = $conexion->prepare("INSERT INTO users (nombreUsuario, contrasenya, cuenta_bank) VALUES (:nombreUsuario,:contrasenya,:cuenta_bank)");
